...
population_reprojection <- resample(population, suitability_attacks, method = "bilinear")

# Saving this
writeRaster(population_reprojection, filename = "population_reprojection.tif", overwrite = TRUE)

# Re-loading rasters
population_reproject <- raster('population_reprojection.tif')
...
high_risk_population <- suitability * population_reproject

# Saving this
writeRaster(high_risk_population, filename = "high_risk_population.tif", overwrite = TRUE)
