...
ggsave("rate_of_attacks.png", plot = rate_of_attacks, width = 10, height = 10, dpi = 300)
```
...
ggsave("pop_LGA.png", plot = pop_LGA, width = 10, height = 5, dpi = 300)
```
...
ggsave("attacks_borno_LGA.png", plot = attacks_borno_LGA, width = 10, height = 5, dpi = 300)
```
